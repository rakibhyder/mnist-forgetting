...
for epoch in range(0,epochs_part):
        for num in range (0,num_classes-1):
                ...
                for rep in range (0,repeat):
                        ...
                        var_batch.append(np.int(np.floor(temp_len/batch_size)+1))
                        k=0
...
#print(test_acc)
np.savez('mnist_result_gradual_cum'+str(epochs),var_batch=var_batch,test_acc_full=test_acc_full,train_acc_full=train_acc_full,train_loss_full=train_loss_full,val_acc_full=val_acc_full,val_loss_full=val_loss_full,test_acc_part=test_acc_part,train_acc_part=train_acc_part,train_loss_part=train_loss_part,val_acc_part=val_acc_part,val_loss_part=val_loss_part)
